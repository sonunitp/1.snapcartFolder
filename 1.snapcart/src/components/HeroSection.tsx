...
//     {
//       id: 1,
//       icon: <Leaf className="w-20 h-20 sm:w-28 sm:h-28 text-red-400 drop-shadow-lg" />,
//       title: "Fresh Organic Groceries 🥦",
//       subtitle: "Farm-fresh fruits, vegetables, and daily essentials delivered to you.",
//       btnText: "Shop Now",
//       bg: "https://plus.unsplash.com/premium_photo-1663012860167-220d9d9c8aca"
//     },
//     {
//       id: 2,
//       icon: <Truck className="w-20 h-20 sm:w-28 sm:h-28 text-red-400 drop-shadow-lg" />,
//       title: "Fast & Reliable Delivery 🚚",
//       subtitle: "We ensure your groceries reach your doorstep in no time.",
//       btnText: "Order Now",
//       bg: "https://images.unsplash.com/photo-1683553170878-049f180627b0"
//     },
//     {
//       id: 3,
//       icon: <Smartphone className="w-20 h-20 sm:w-28 sm:h-28 text-red-400 drop-shadow-lg" />,
//       title: "Shop Anytime, Anywhere 📱",
//       subtitle: "Easy and seamless online grocery shopping experience.",
//       btnText: "Get Started",
//       bg: "https://plus.unsplash.com/premium_photo-1663091378026-7bee6e1c7247"
//     },
//   ]
...
//             whileHover={{ scale: 1.09 }}
//             whileTap={{ scale: 0.96 }}
//             className='mt-4 bg-white text-red-600 hover:bg-red-100 px-8 py-3 rounded-full font-semibold shadow-lg flex items-center gap-2'
//           >
//             <ShoppingBasket className='w-5 h-5' />
//             {slides[current].btnText}
//           </motion.button>
