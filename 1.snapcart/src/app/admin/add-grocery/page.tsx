            ...
            >
                ...
                <form className='flex flex-col gap-6 w-full' onSubmit={handleSubmit}>
                    ...
                    <div className='flex flex-col sm:flex-row items-center gap-5'>
                        <label
                            htmlFor="image"
                            className='cursor-pointer flex items-center gap-2 bg-green-50 text-green-700 font-semibold border border-green-200 rounded-xl px-6 py-3 hover:bg-green-100'
                        >
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        disabled={loading}
                        className='mt-4 w-full bg-gradient-to-r from-green-500 to-green-700 text-white font-semibold py-3 rounded-xl shadow-lg flex items-center justify-center gap-2 disabled:opacity-60'
                    >
                        {loading ? (
